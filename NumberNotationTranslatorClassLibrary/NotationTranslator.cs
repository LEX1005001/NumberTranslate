...
namespace NumberNotationTranslatorClassLibrary
{
    ...
    public class ClassTranslate
    {
        ...
        public static string notation10_Int(string x, int n)
        {
            if (n == 10)
                return x;
            int x10 = dig2int(x[0]);
        ...
        public static string notation10_Fract(string x, int n)
        {
            if (n == 10)
                return x;
            string xZero = "0" + x;
        ...
        public static string Ten2Q_int(string x, int Q)
        {
            if (Q == 0)
                return x;
            string xQ = "";
        ...
        /// <returns></массив строк(нулевой элемент -целая часть, первый-дробная часть ч.>
